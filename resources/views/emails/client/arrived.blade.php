        ...
        <div>
            <div style="padding: 25px 25px;display: inline-flex;">
                <div class="header-content-left" style="margin-top: auto;margin-left: 15px;margin-bottom: auto;">
                    <img src="https://app.blackhansa.de/mail-icons/client-11.png" width="50px">
                </div>

                <div class="header-content-right" style="margin-left: 25px;">
                    <p style="color: #ffffff;margin: 0;font-size: 22px;font-weight: 700;">Chauffeur has arrived!</p>
                    <p style="color:#9e9e9e;font-size: 12px;margin-top: 10px;">Dear <span style="font-weight:500;color:#fff;">Dragus Patrick, </span></p>
                    <p style="color:#745A3C;font-size: 12px;margin-top: 10px;margin-bottom: 0;">Your chauffeur is in pickup position and ready to meet you.</p>
                </div>
            </div>
