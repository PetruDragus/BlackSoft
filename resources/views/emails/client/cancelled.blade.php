...
<div class="wrapper">
        ...
        <div>
            <div style="padding: 25px 25px;display: inline-flex;">
                ...
                <div class="header-content-right" style="margin-left: 35px;">
                    <p style="color: #ffffff;margin: 0;font-size: 22px;font-weight: 700;">Booking cancelled!</p>
                    <p style="color:#9e9e9e;font-size: 12px;margin-top: 10px;">Dear <span style="font-weight:500;color:#fff;">Dragus Patrick,</span></p>
                    <p style="color:#FF0000;font-size: 12px;margin-top: 10px;margin-bottom: 0;">Thank you for choosing Blackhansa.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="content" style="padding: 25px 0px;">
        ...
        <hr class="divider" style="border-top: 1px solid #FF0000;margin: 15px 0;">
