...
<div class="wrapper">
        ...
        <div>
            <div style="padding: 25px 25px;display: inline-flex;">
                ...
                <div class="header-content-right" style="margin-left: 35px;">
                    ...
                    <p style="color:#809E46;font-size: 12px;margin-top: 10px;margin-bottom: 0;">Below you can find the ride information:</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="content" style="padding: 25px 0px;">
        ...
        <hr class="divider" style="border-top: 1px solid #809E46;margin: 15px 0;">
