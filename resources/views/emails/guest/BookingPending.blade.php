...
<div class="wrapper">
        ...
        <div>
            <div style="padding: 25px 25px;display: inline-flex;">
                <div class="header-content-left" style="margin-top: auto;margin-left: 20px;margin-bottom: auto;">
                    <img src="https://app.blackhansa.de/mail-icons/mail_V3-29.png" width="50px">
                </div>

                <div class="header-content-right" style="margin-left: 35px;">
                    <p style="color: #ffffff;margin: 0;font-size: 24px;font-weight: 700;">Booking registered!</p>
                    ...
                    <p style="color:#97999C;font-size: 12px;margin-top: 10px;margin-bottom: 0;">You will receive confirmation as soon as possible. </p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="content" style="padding: 25px 0px;">
        <div class="row" style="display: flex;">
            <div class="item multi-columns" style="display:flex; flex-wrap:wrap;;width:60%;">
                <div class="icon-box">
                ...
                <div class="item-wrap" style="margin-left: 10px;">
                    ...
                    <p class="item-subtitle" style="margin-bottom: 3px;margin-top: 0;font-size: 12px;">
                        {{ $booking['vehicle']['make'] }} {{ $booking['vehicle']['model'] }}
                    </p>

                    <p class="item-subtitle" style="margin-top: 0;font-size: 12px;margin-bottom: 3px;">
                        Max. {{ $booking['vehicle']['passagers'] }} guests
                    </p>

                    <p class="item-subtitle" style="margin-top: 0;font-size: 12px;margin-bottom: 3px;">
                        Max. {{ $booking['vehicle']['bags'] }} luggage
                    </p>
                </div>
            </div>

            <div class="item multi-columns" style="display: flex;width:40%;">
                <div class="icon-box">
        ...
        <hr class="divider" style="border-top: 1px solid #97999C;margin: 15px 0;">
        ...
        <div class="row" style="display: flex;">
            <div class="item multi-columns" style="display: flex;width:60%;">
                <div class="icon-box">
        ...
        <div class="row" style="margin-top: 25px;display: flex;">
            <div class="item multi-columns" style="display: flex;width:60%;">
                ...
                <div class="item-wrap" style="margin-left: 10px;">
                    ...
                    <p class="item-subtitle" style="font-size: 12px;margin-top: 0;margin-bottom:3px;">
                        {{ $booking['name'] }}
                    </p>
