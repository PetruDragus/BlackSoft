        ...
        <div>
            <div style="padding: 25px 25px;display: inline-flex;">
                <div class="header-content-left" style="margin-top: auto;margin-left: 20px;margin-bottom: auto;">
                    <img src="https://app.blackhansa.de/mail-icons/icon/icons-20.png" width="50px">
                </div>

                <div class="header-content-right" style="margin-left: 35px;">
                    <p style="color: #ffffff;margin: 0;font-size: 22px;font-weight: 700;">Chauffeur is on the way!</p>
                    ...
                    <p style="color:#F1B255;font-size: 12px;margin-top: 10px;margin-bottom: 0;">Your chauffeur has confirmed he is on the way to the pick-up location.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="content" style="padding: 25px 0px;">
        <div class="row" style="display: flex;">
            <div class="item multi-columns" style="display:flex; flex-wrap:wrap;;width:60%;">
                <div class="icon-box">
                    <img src="https://app.blackhansa.de/mail-icons/icon/mail_V3-55.png" width="25px">
                </div>
        ...
        <hr class="divider" style="border-top: 1px solid #F1B255;margin: 15px 0;">
