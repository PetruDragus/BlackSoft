        ...
        <div>
            <div style="padding: 25px 25px;display: inline-flex;">
                ...
                <div class="header-content-right" style="margin-left: 35px;">
                    <p style="color: #ffffff;margin: 0;font-size: 24px;font-weight: 700;">Chauffeur has arrived!</p>
                    ...
                    <p style="color:#F1B255;font-size: 12px;margin-top: 10px;margin-bottom: 0;">Your chauffeur is at pick-up location and ready to meet you. </p>
                </div>
            </div>
        </div>
    </div>
