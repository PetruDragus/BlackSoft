                ...
                <div id="subheader_pg" class="subHeader__block">
                    ...
                    <div class="float-right">
                        <div style="display: flex;">
                            <a href="/payments/create" class="btn btn-label-brand btn-bold">
                                Add Payment
                            </a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <a class="dropdown-item" href="/export/payments/exportExcel">
                                        <i class="far fa-file-excel"></i>
                                        <span class="nav__link-text">Excel</span>
                                    </a>
                                    <a class="dropdown-item"  href="/export/payments/exportCSV">
    ...
    export default {
        ...
        methods: {
            ...
            fetchIndexData() {
                ...
                const url = 'http://127.0.0.1:8000/api/payments?column=' + this.query.column + '&direction=' + this.query.direction + '&page=' + this.query.page + '&per_page=' + this.query.per_page + '&search_column=' + this.query.search_column + '&search_operator=' + this.query.search_operator + '&search_input=' + this.query.search_input;
