                ...
                <div id="subheader_pg" class="subHeader__block">
                    <div class="float-left" style="display:flex;">
                        <div class="subheader__page__title">
                            <h6>Follow-up - Cancelled Trips</h6>
                        </div>
                    ...
                    <div class="float-right">
                        <div style="display: flex;">
                            <a href="/bookings" class="btn btn-label-brand btn-bold">
                                Return to all trips
                            </a>
    ...
    export default {
        ...
        data() {
            return {
                ...
                model: {},
                columns: {},
                source: '/api/v1/bookings/cancelled',
                query: {
                    page: 1,
                    column: 'id',
                    direction: 'desc',
        ...
        methods: {
            ...
            fetchIndexData() {
                ...
                const url = '/api/v1/bookings/cancelled?column=' + this.query.column + '&direction=' + this.query.direction + '&page=' + this.query.page + '&per_page=' + this.query.per_page + '&search_column=' + this.query.search_column + '&search_operator=' + this.query.search_operator + '&search_input=' + this.query.search_input;
