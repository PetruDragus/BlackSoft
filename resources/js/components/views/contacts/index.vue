                ...
                <div id="subheader_pg" class="subHeader__block">
                    ...
                    <div class="float-right">
                        <div style="display: flex;">
                            <a href="/contacts/create" class="btn btn-label-brand btn-bold">
                                Add Contact
                            </a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <a class="dropdown-item" href="/export/contacts/exportExcel">
                                        <i class="far fa-file-excel"></i>
                                        <span class="nav__link-text">Excel</span>
                                    </a>
                                    <a class="dropdown-item"  href="/export/contacts/exportCSV">
            ...
            return {
                ...
                filterable: {
                    ...
                    orderables: [
                        ...
                        {title: 'Phone No.', name: 'phone', type: 'string'},
                        {title: 'Notes', name: 'phone', type: 'string'},
