                ...
                <div id="subheader_pg" class="subHeader__block">
                    ...
                    <div class="float-right">
                        <div style="display: flex;">
                            <a href="/invoices/create" class="btn btn-label-brand btn-bold">
                                Add Invoice
                            </a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <a class="dropdown-item" href="/export/invoices/exportExcel">
                                        <i class="far fa-file-excel"></i>
                                        <span class="nav__link-text">Excel</span>
                                    </a>
                                    <a class="dropdown-item"  href="/export/invoices/exportCSV">
                ...
                <table class="dv-table table">
                    ...
                    <tbody>
                        ...
                        <tr v-for="row in model.data">
                            ...
                            <td>{{ row.total | formatMoney }}</td>
                            <td>
                                <span v-if="row.status == 'Sent'" class="status status-light_green">
                                    <span class="status-text">{{ row.status }}</span>
                                </span>

                                <span v-if="row.status == 'Paid'" class="status status-blue">
                                    <span class="status-text">{{ row.status }}</span>
                                </span>
                            </td>
                            <td>
                                <div class="bk-span-actions" style="overflow: visible; position: relative; width: 80px;color: #595d6e;font-size: 1rem;">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" v-bind:href="'/invoices/'+row.id">
                                                <i class="far fa-eye"></i>
                                                <span class="nav__link-text">View</span>
                                            </a>
                                            <a class="dropdown-item" v-bind:href="'/invoices/'+row.id+'/edit'">
    ...
    export default {
        ...
        methods: {
            ...
            fetchIndexData() {
                ...
                const url = '/api/v1/invoices?column=' + this.query.column + '&direction=' + this.query.direction + '&page=' + this.query.page + '&per_page=' + this.query.per_page + '&search_column=' + this.query.search_column + '&search_operator=' + this.query.search_operator + '&search_input=' + this.query.search_input;
