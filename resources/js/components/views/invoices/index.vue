            ...
            <div class="dv-body table-responsive">
                <filterable v-bind="filterable">
                    ...
                    <tr slot-scope="{ item }">
                        ...
                        <td v-else>N/A</td>
                        <th v-if="item.booking">{{ item.booking.id }}</th>
                        <th v-else>N/A</th>
                        <td>{{ item.discount }}</td>
                            ...
                            <div class="bk-span-actions" style="overflow: visible; position: relative; width: 80px;color: #595d6e;font-size: 1rem;">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" v-bind:href="'/invoices/'+item.id+'/edit'">
            ...
            return {
                ...
                filterable: {
                    ...
                    orderables: [
                        ...
                        {title: 'Customer ID', name: 'customer_id', type: 'string'},
                        {title: 'Booking ID', name: 'booking_id', type: 'string'},
                        {title: 'Discount', name: 'discount', type: 'string'},
