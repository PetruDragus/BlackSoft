                ...
                <div id="subheader_pg" class="subHeader__block">
                    ...
                    <div class="float-right">
                        <div style="display: flex;">
                            <a href="/coupons/create" class="btn btn-label-brand btn-bold">
                                Generate Coupon
                            </a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <a class="dropdown-item" href="/export/coupons/exportExcel">
                                        <i class="far fa-file-excel"></i>
                                        <span class="nav__link-text">Excel</span>
                                    </a>
                                    <a class="dropdown-item" href="/export/coupons/exportCSV">
            ...
            <div class="dv-body table-responsive">
                <table class="dv-table table">
                    ...
                    <tr v-for="row in model.data">
                        ...
                        <td>{{ row.expire_date | formatDate }}</td>
                            ...
                            <div class="bk-span-actions" style="overflow: visible; position: relative; width: 80px;color: #595d6e;font-size: 1rem;">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" v-bind:href="'/coupons/'+row.id+'/edit'">
                                            <i class="far fa-edit"></i>
                                            <span class="nav__link-text">Edit</span>
                                        </a>
                                        <a class="dropdown-item" @click="deleteCoupon(row.id)">
        ...
        methods: {
            ...
            deleteCoupon(id) {
                ...
                // Send request to the server
                    axios.delete( '/api/v1/coupons/'+id)
            ...
            fetchIndexData() {
                ...
                const url = '/api/v1/coupons?column=' + this.query.column + '&direction=' + this.query.direction + '&page=' + this.query.page + '&per_page=' + this.query.per_page + '&search_column=' + this.query.search_column + '&search_operator=' + this.query.search_operator + '&search_input=' + this.query.search_input;
